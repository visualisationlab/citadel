...
// private isBasicGraph(val: unknown): asserts val is Types.BasicGraph {
...
// private isEdge(val: unknown, index: number): asserts val is Types.BasicEdge {
//     if (typeof val !== 'object' || val === null) {
...
// private isNode(val: unknown, index: number): asserts val is Types.BasicNode {
//     if (typeof val !== 'object' || val === null) {
