...
exports.checkGraph = exports.graphSchema = void 0;
const jsonschema_1 = require("jsonschema");
const validator = new jsonschema_1.Validator();
// Parses JSON for use by cytoscape.
function parseJson(nodes, edges) {
    return {
        elements: {
...
function checkGraph(data) {
    const vr = validator.validate(data, exports.graphSchema);
    const f = (_newData) => {
        return vr.valid;
    };
    f(data);
