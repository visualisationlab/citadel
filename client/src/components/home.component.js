...
// const tabs = ['Mapping', 'Filter', 'Layout', 'Edit', 'Simulate', 'Content', 'Session'] as const
// type Tabs = typeof tabs[number]
// type Param = {
//     sid: string
// }
// type MarkerDict = {[name in VisGraph.Marker]: VisGraph.MarkerObject}
// type ColourDict = {[name in VisGraph.Marker]: VisGraph.ColourSettings}
// /**
...
//     const [graphDimensions, setGraphDimensions] = useState<VisGraph.GraphDimensions>({
...
//     function selectionStateReducer(state: VisGraph.SelectionState, action: VisGraph.SelectionReducerAction) : SelectionState {
//         switch (action.type) {
//             case "reset":
//                 return {
//                     selectedNodeID: "",
...
//      * @param id
//      */
//      function removeNode(state: GraphState, id: string) : GraphState {
...
//         return newState;
//     }
//     function updateVisualization(   prevMapping : VisGraph.MarkerObject,
//                                     graphState: GraphState,
//                                     marker : Marker,
//                                     selectedMap : AttributeType,
//                                     attributeName : string) : VisGraph.MarkerObject {
...
//         if (selectedMap === 'None' && supportedMaps.length > 0) {
...
//     function graphStateReducer(state: GraphState, action: VisGraph.graphStateReducerAction) : GraphState {
//         switch(action.type) {
//             case "load":
//                 // A dict of node information for fast lookup.
//                 let nodeDict : VisGraph.NodeDict = {};
...
//                 const nodeList = action.data.nodes.map((node : VisGraph.GraphNode) => {
//                     nodeDict[node.id] = {
//                         x: 0,
//                         y: 0,
//                         id: node.id,
...
//                     };
//                 });
//                 let links = action.data.edges.map((link : VisGraph.Link) => {
...
//                     mappings: mappings,
//                     links: links,
//                     graphType: action.data.attributes.edgeType === "directed" ? VisGraph.GraphType.Directed : VisGraph.GraphType.Undirected
//                 }
//             case "remove":
...
//         graphType: VisGraph.GraphType.Undirected
//     });
//     /**
//      * Either adds new colour, or changes existing colour.
//      */
//      function colourDictReducer(state: ColourDict, action : VisGraph.ColourDictReducerAction) : ColourDict {
//         const newState = {...state};
//         switch(action.type) {
//             case 'setCount':
...
//      * @param {VisGraph.GraphNode[]} nodes
//      * @param {string} attributeName
//      * @returns [attributeMin, attributeMax]
//      */
//     function analyzeScalar( nodes : VisGraph.GraphNode[],
...
//     }
//     function analyzeGroup(  nodes : VisGraph.GraphNode[],
//                             attributeName : string,
//                             colourMap : VisGraph.Colour[]) {
//         let attributeGroup : {[group: string] : VisGraph.Colour} = {};
//         let groupIndex = 0;
//         nodes.forEach((node) => {
//             const value = node.attributes[attributeName];
...
//     }
//     function analyzeDate(   nodes : VisGraph.GraphNode[],
//                             attributeName : string) {
//         let attributeMin = Number.MAX_SAFE_INTEGER;
//         let attributeMax = Number.MIN_SAFE_INTEGER;
//         nodes.forEach((node) => {
...
//      */
//     function generateCSSGradient(   colours : VisGraph.Colour[],
//                                     colourCount : number) {
...
//      * @returns
//      */
//     const onNodeClick = function(id : string) {
//         if (selectionState.selectedType === VisGraph.SelectionType.Delete) {
...
//      * @returns Colour
//      */
//     function getSelectionColour(id : string,
...
//      * @returns colour
//      */
//     function getAnalyzeColour(  id : string,
//                                 markerObject : VisGraph.MarkerObject,
...
//                         colourMap : VisGraph.MarkerObject,
//                         colourSettings : ColourSettings) {
//         if (colourMap.name === "" ||
...
//     }
//     function getLineWidth(id: string) {
//         return 4.0;
//     }
//     function getLineAlpha(link : VisGraph.Link, selectionState: SelectionState) {
...
//             return 1.0
//         }
//         if (selectionState.selectedType === VisGraph.SelectionType.ShortestPath &&
...
//         return 0.1
//     }
//     function getLineColour(link: VisGraph.Link, selectionState: SelectionState) {
//         if (selectionState.highlightedNodeIDs.length === 0) {
//             return 0;
//         }
//         if (selectionState.highlightedNodeIDs.includes(link.source.id) &&
...
//      */
//      function getValidAttributeTypes(nodes : VisGraph.GraphNode[], attributeName : string) : AttributeType[] {
//         let isDate = false;
//         let isGroup = true;
//         let isScalar = true;
//         let types = [];
...
//      * @returns JSX
//      */
//     function renderColourPicker(colours : VisGraph.Colour[],
//                                 marker : Marker) {
...
//                     switch (marker) {
//                         case Marker.FillColour:
//                             colourDictDispatch({type: 'updateColour', colour: [R / 255, G / 255, B / 255], index: i, marker: VisGraph.Marker.FillColour});
//                             return;
//                         case Marker.EdgeColour:
//                             colourDictDispatch({type: 'updateColour', colour: [R / 255, G / 255, B / 255], index: i, marker: VisGraph.Marker.EdgeColour});
//                             return;
//                     }
//                 }}/>
//             </div>)
...
//                                 Math.random(), Math.random()], index: colourDict[marker].colours.length, marker: VisGraph.Marker.FillColour});
//                             return;
//                         case Marker.EdgeColour:
//                             colourDictDispatch({type: 'updateColour', colour: [Math.random(),
//                                 Math.random(), Math.random()], index: colourDict[marker].colours.length, marker: VisGraph.Marker.EdgeColour});
//                             return;
//                     }
...
//                             onClick={
//                                 () => graphSettingsDispatch({attribute: VisGraph.GraphSettingsAttribute.Charge,
...
//                             onChange={
//                                 (e) => graphSettingsDispatch({attribute: VisGraph.GraphSettingsAttribute.Charge,
...
//                     <button type="button"
//                             className="btn btn-light"
//                             onClick={() => graphSettingsDispatch({attribute: VisGraph.GraphSettingsAttribute.CollideStrength,
...
//                             onChange={(e) => graphSettingsDispatch({attribute: VisGraph.GraphSettingsAttribute.CollideStrength,
...
//                     <button type="button"
//                             className="btn btn-light"
//                             onClick={() => graphSettingsDispatch({attribute: VisGraph.GraphSettingsAttribute.RadialForce,
...
//                             onChange={(e) => graphSettingsDispatch({attribute: VisGraph.GraphSettingsAttribute.RadialForce,
//                                 value: parseInt(e.target.value)})
//                     }>
//                     </input>
//                     <button type="button"
...
//                     <button type="button"
//                             className="btn btn-light"
//                             onClick={() => graphSettingsDispatch({attribute: VisGraph.GraphSettingsAttribute.DefaultNodeRadius,
...
//                     onChange={(e) => graphSettingsDispatch({attribute: VisGraph.GraphSettingsAttribute.DefaultNodeRadius,
//                         value: parseInt(e.target.value)})
//                     }>
//                     </input>
//                     <button type="button" className="btn btn-light" onClick={() => graphSettingsDispatch({attribute: VisGraph.GraphSettingsAttribute.DefaultNodeRadius,
//                                 value: graphSettings.defaultNodeRadius + 1})}>+1</button>
//                 </div>
//                 <p>Line Opacity</p>
//                 <div className="d-flex flex-row justify-content-between numericalSetting">
//                     <button type="button"
//                             className="btn btn-light"
//                             onClick={() => graphSettingsDispatch({attribute: VisGraph.GraphSettingsAttribute.LineOpacity,
...
//                     onChange={(e) => graphSettingsDispatch({attribute: VisGraph.GraphSettingsAttribute.LineOpacity,
//                         value: parseFloat(e.target.value)})
//                     }>
//                     </input>
//                     <button type="button" className="btn btn-light" onClick={() => graphSettingsDispatch({attribute: VisGraph.GraphSettingsAttribute.LineOpacity,
//                                 value: graphSettings.lineOpacity + 0.05})}>+0.05</button>
//                 </div>
//                 <hr></hr>
//                 <p>Selected Graph</p>
...
//                     onChange={() =>
//                         graphSettingsDispatch({attribute: VisGraph.GraphSettingsAttribute.SmoothScroll,
...
//                     onChange={(e) =>
//                         graphSettingsDispatch({attribute: VisGraph.GraphSettingsAttribute.TickInterval,
//                                 value: parseInt(e.target.value)})
//                     }></input></p>
//                 <div className="d-flex flex-row justify-content-between numericalSetting">
//                     Max Lines Drawn: <input type="number" min="50" max="25000" size={5} value={graphSettings.maxLinesDrawn}
//                     onChange={(e) => graphSettingsDispatch({attribute: VisGraph.GraphSettingsAttribute.MaxLinesDrawn,
//                         value: parseInt(e.target.value)})
//                     }></input>
//                     Max Nodes Drawn: <input type="number" min="10" max="25000" size={5} value={graphSettings.maxCirclesDrawn}
//                     onChange={(e) => graphSettingsDispatch({attribute: VisGraph.GraphSettingsAttribute.MaxCirclesDrawn,
//                         value: parseInt(e.target.value)})
//                     }></input>
//                 </div>
//                 Extreme Edge Culling: <input type="checkbox"
//                     defaultChecked={graphSettings.extremeLineCulling}
//                     onChange={() => graphSettingsDispatch({attribute: VisGraph.GraphSettingsAttribute.ExtremeLineCulling,
//                         value: !graphSettings.extremeLineCulling})
//                     }></input>
//                 <hr></hr>
//                 Render Edges: <input type="checkbox" defaultChecked={graphSettings.renderEdges}
//                     onChange={() => graphSettingsDispatch({attribute: VisGraph.GraphSettingsAttribute.RenderEdges,
...
//                         }}>
//                         <option value={VisGraph.SelectionType.Neighbours}>Neighbors</option>
//                         <option value={VisGraph.SelectionType.ShortestPath}>Shortest path</option>
//                         <option value={VisGraph.SelectionType.Delete}>Delete</option>
//                     </select>
//                 </div>
//                 <div>
//                     <hr></hr>
...
//         return (
//             <div className="menuContents">
//                 <p>Graph type: {VisGraph.GraphType[graphState.graphType]}</p>
//                 <hr></hr>
...
//                             getEdgeColour = {(id: string) => {return getColour(id, graphState.mappings['EdgeColour'], colourDict[Marker.EdgeColour])}}
